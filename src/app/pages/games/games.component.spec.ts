...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
    ...
    expect(updateUserDataSpy).toHaveBeenCalledWith('user123', { games: [mockGame] });
  ...
  it('should navigate to a specific page and fetch games', () => {
    ...
    const filteredGamesSpy = jest.spyOn(component, 'filteredGames').mockImplementation();
  ...
  it('should call getGames if no filters are applied', () => {
    const getGamesSpy = jest.spyOn(component, 'getGames').mockImplementation(() => {noop()});
